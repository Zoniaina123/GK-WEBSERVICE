...
public class ObjectFactory {
    ...
    private final static QName _ConversionEuroToDResponse_QNAME = new QName("http://ws/", "ConversionEuroToDResponse");
    private final static QName _GetComptes_QNAME = new QName("http://ws/", "getComptes");
    private final static QName _ConversionEuroToD_QNAME = new QName("http://ws/", "ConversionEuroToD");
    ...
    /**
     * Create an instance of {@link ConversionEuroToDResponse }
     * 
     */
    public ConversionEuroToDResponse createConversionEuroToDResponse() {
        return new ConversionEuroToDResponse();
    }
    ...
    /**
     * Create an instance of {@link ConversionEuroToD }
     * 
     */
    public ConversionEuroToD createConversionEuroToD() {
        return new ConversionEuroToD();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ConversionEuroToDResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws/", name = "ConversionEuroToDResponse")
    public JAXBElement<ConversionEuroToDResponse> createConversionEuroToDResponse(ConversionEuroToDResponse value) {
        return new JAXBElement<ConversionEuroToDResponse>(_ConversionEuroToDResponse_QNAME, ConversionEuroToDResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ConversionEuroToD }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws/", name = "ConversionEuroToD")
    public JAXBElement<ConversionEuroToD> createConversionEuroToD(ConversionEuroToD value) {
        return new JAXBElement<ConversionEuroToD>(_ConversionEuroToD_QNAME, ConversionEuroToD.class, null, value);
    }
